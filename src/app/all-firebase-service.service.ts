...
export class AllFirebaseServiceService {
  ...
  async setUserAccount(userData:UserAccount,userUid:any){
  ...
  getUserDetails(userUid:any){
    return this.db.collection("AllUsers",ref=>ref.where("userId","==",userUid)).snapshotChanges()
  }
  getAllSongs(){
